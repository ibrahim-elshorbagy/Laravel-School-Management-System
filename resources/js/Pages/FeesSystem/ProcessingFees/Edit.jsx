...
export default function Add({ auth, processing_fees }) {
    const { data, setData, post, errors, reset } = useForm({
        student_id: processing_fees.student_id,
        name: processing_fees.student,
        amount: processing_fees.amount,
        description: "",
        _method: "PUT",
    });
    ...
    const onSubmit = (e) => {
        ...
        post(route("processing-fee.update", processing_fees.id));
    };
