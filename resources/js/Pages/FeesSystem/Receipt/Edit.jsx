...
export default function Edit({ auth, receipt_student}) {
    const { data, setData, post, errors, reset } = useForm({
        student_id: receipt_student.student_id,
        student_name: receipt_student.student,
        debit: receipt_student.debit || "",
        description: receipt_student.description || "",
    ...
    const onSubmit = (e) => {
        ...
        post(route("receipt-student.update", receipt_student.id));
    };
            ...
            header={
                <div className="flex items-center justify-between">
                    <h2 className="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200">
                        Edit Received Money From {data.student_name}
                    </h2>
                </div>
            }
        >
