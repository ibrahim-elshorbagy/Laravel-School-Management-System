...
export default function Create({ auth, StudentServicesManager }) {
    const { data, setData, post, errors, reset } = useForm({
        email: StudentServicesManager.user.email || "",
        password: StudentServicesManager.user.password || "",
        name: StudentServicesManager.user.name || "",

        phone: StudentServicesManager.phone || "",
        job: StudentServicesManager.job || "",
        address: StudentServicesManager.address || "",
    ...
    const onSubmit = (e) => {
        ...
        post(
            route("student-services-managers.update", StudentServicesManager.id)
        );
    };
            ...
            header={
                <div className="flex items-center justify-between">
                    <h2 className="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200">
                        Create new Student Services Manager
                    </h2>
                </div>
            }
        >
